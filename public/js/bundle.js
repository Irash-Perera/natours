    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Signed up succesfully');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Check your mail box.');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
// Initialize Stripe
var stripePromise = (0, _stripeJs.loadStripe)(undefined);
...
},{"axios":"../../node_modules/axios/index.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js","./alert":"alert.js"}],"review.js":[function(require,module,exports) {
"use strict";
...
var submitReview = exports.submitReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(review, rating) {
    var tour, user, tourSlug, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          tour = document.querySelector('.login-form').getAttribute('data-tour-id');
          user = document.querySelector('.login-form').getAttribute('data-user-id');
          tourSlug = document.querySelector('.login-form').getAttribute('data-tour-slug');
          _context.prev = 3;
          _context.next = 6;
          return (0, _axios.default)({
            method: 'POST',
  ...
  return function submitReview(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var userSettings = document.querySelector('.form-user-settings');
...
var bookAgainBtn = document.querySelector('.book-again-btn');
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _passwordReset.passwordReset)(newPassword, newPasswordConfirm, token);
  });
}
if (forgotPasswordFrom) {
  forgotPasswordFrom.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (userSettings) {
  userSettings.addEventListener('submit', /*#__PURE__*/function () {
    ...
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            review = document.getElementById('_review').value;
            if (starGroup) {
            ...
            _context3.next = 5;
            return (0, _review.submitReview)(review, rating);
          case 5:
          case "end":
